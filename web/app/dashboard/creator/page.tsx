    ...
    <main className="min-h-screen p-8">
      <header className="flex justify-between items-center mb-8 max-w-5xl mx-auto">
        <div>
          <span className="font-script text-pink-bright text-xl -rotate-2 inline-block mb-1">
            hey {user.fullName?.split(' ')[0] ?? 'creator'}
          </span>
          <h1 className="font-display text-3xl">Creator dashboard</h1>
        </div>
      ...
      <div className="max-w-5xl mx-auto bg-white border-2 border-ink rounded-xl p-8">
        ...
        <p className="text-ink-3">
          Overview, profile editor, job board, applications, deal tracker, pitch log,
          invoices, earnings, notifications. Building these out next.
        </p>
